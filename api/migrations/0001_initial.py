# Generated by Django 4.2.6 on 2023-11-23 21:08
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('follower', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='foreign_following_relations', to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'unique_together': {('follower', 'following')},
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('post', models.URLField()),
                ('author_follow_relation', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='granted_post_access_permissions_foreign', to='api.followforeign')),
                ('target_follow_relation', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='receceived_post_access_permissions_foreign', to='api.followforeign')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='post_access_permissions_foreign', to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'unique_together': {('user', 'post')},
            },
