...
urlpatterns = [
    ...
    path('authors/<uuid:author_id>/followers', authors.FollowerList.as_view(), name='author_followers'),
    ...
    path('authors/<uuid:author_id>/posts/<uuid:post_id>/inbox', authors.AuthorInboxList.as_view(), name='author_post_inbox'),
]